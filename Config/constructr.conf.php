<?php 
    ...
    $_CONSTRUCTR_CONF = array(
        ...
        '_VERSION_DATE' => '20140625', // VERSION DATE OF CONSTRUCTR CMS
        '_VERSION' => '1.00.2', // VERSION OF CONSTRUCTR CMS
        '_SALT' => '', // SECURITY SALT
        ...
        '_EXT_WWW' => '', // ROUTING STATIC TO A SPECIAL DOMAIN/FRONTEND
        ...
        '_MAGIC_GENERATION_KEY' => '', // MAGIC KEY FOR READING CONSTRUCTR FRONTEND OUTPUT - STATIC WEBPAGE GENERATION
        ...
        '_MEDIA_BASE_TITLE' => 'Media base title', // MEDIA BASE TITLE
        '_MEDIA_BASE_COPYRIGHT' => 'Media Base copyright', // MEDIA BASE COPYRIGHT
        '_MEDIA_BASE_DESCRIPTION' => 'Media base description', // MEDIA BASE DESCRIPTION
        '_MEDIA_BASE_KEYWORDS' => 'Media base keywords', // MEDIA BASE KEYWORDS
    );