                                        ...
                                        if($PAGES_COUNTR || $BACKEND_USER_COUNTR || $UPLOADS_COUNTR)
                                        {
                                            ?>
                                                ...
                                                <ul class="list-group">
                                                      ...
                                                      <li class="list-group-item">
                                                            <a href="<?php echo $_CONSTRUCTR_CONF['_BASE_URL']; ?>/Logfiles/<?php echo date('Ymd'); ?>.log" title="Logfile anzeigen" onclick="window.open(this.href);return false;">Aktuelles Logfile anzeigen</a>
                                                      </li>
                                                </ul>
                                            <?php
                                        }
