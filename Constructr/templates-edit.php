                ...
                <div class="row">
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
						...
						<ul class="nav nav-pills">
							...
							<li role="presentation" class="active"><a href="<?php echo $_CONSTRUCTR_CONF['_BASE_URL'];?>/constructr/templates/edit/<?php echo $ORIGIN_TEMPLATE; ?>/">Template bearbeiten</a></li>
						</ul>
                    </div><!-- // EOF COL-... -->
