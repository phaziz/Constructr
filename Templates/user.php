                                            ...
                                            <?php
                                                if($BACKENDUSER)
                                                {
                                                    foreach ($BACKENDUSER as $USER)
                                                    {
                                                        ...
                                                        echo '&#160;&#160;<a data-toggle="tooltip" data-placement="top" title="Benutzerrechte bearbeiten" class="tt user-rights-editer" href="' . _BASE_URL . '/constructr/user/edit-user-rights/' . ($USER['beu_id']) . '/' . ($USER['beu_username']) . '/"><button type="button" class="btn btn-info btn-xs" title="Benutzerrechte Editieren"><span class="glyphicon glyphicon-edit"></span></button></a>';
