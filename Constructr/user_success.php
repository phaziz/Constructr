<!DOCTYPE html>
    ...
    <!--[if gt IE 8]><!--> <html class="no-js" lang="en"><!--<![endif]-->
        <head>
            ...
            <meta http-equiv="refresh" content="5; URL=<?php echo $_CONSTRUCTR_CONF['_BASE_URL'] . '/constructr/user/'; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                <div class="jumbotron">
                                    ...
                                    <br><br>
                                    <div class="alert alert-success">Der Benutzer wurde wie gew&uuml;nscht angelegt / bearbeitet | <a href="<?php echo $_CONSTRUCTR_CONF['_BASE_URL'] . '/constructr/user/' ?>">OK</a></div>
                                </div><!-- // EOF JUMBOTRON -->
                            </div><!-- // EOF COL-... -->
                            <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1"></div><!-- // EOF COL-... -->
                        </div><!-- // EOF ROW -->
