            ...
            <div id="wrapper" class="active">
                <div id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-nav" id="sidebar">     
                        ...
                        <li class="active"><a class="tt" href="<?php echo _BASE_URL ?>/constructr/pages/" title="Seitenverwaltung anzeigen" data-toggle="tooltip" data-placement="right">Seiten</a></li>
                ...
                <div id="page-content-wrapper">
                    <div class="page-content inset">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                <div class="jumbotron">
                                    <h2><?php echo $PAGES_COUNTR; ?> Angelegte Seiten <a data-toggle="tooltip" data-placement="top" title="Neue Seite erstellen" class="tt" href="<?php echo _BASE_URL . '/constructr/pages/new/' ?>"><button type="button" class="btn btn-info btn-sm" title="Neue Seite"><span class="glyphicon glyphicon-plus"></span></button></a></h2>
                                    <br><br>
                                            ...
                                            <?php
                                                if($PAGES){
                                                    foreach ($PAGES as $PAGE)
                                                    {
                                                        ...
                                                        {
                                                            echo '<a data-toggle="tooltip" data-placement="top" title="Seite nach oben verschieben" class="reorder tt" href="' . _BASE_URL . '/constructr/pages/reorder/up/' . $PAGE['pages_id'] . '/"><button type="button" class="btn btn-primary btn-xs" title="Seite nach oben verschieben"><span class="glyphicon glyphicon-arrow-up"></span></button></a>';
                                                            echo '&#160;';                                                    
                                                        }
                                                        if($PAGE['pages_lower'] != 0)
                                                        {
                                                            echo '<a data-toggle="tooltip" data-placement="top" title="Seite nach unten verschieben" class="reorder tt" href="' . _BASE_URL . '/constructr/pages/reorder/down/' . $PAGE['pages_id'] . '/"><button type="button" class="btn btn-primary btn-xs" title="Seite nach unten verschieben"><span class="glyphicon glyphicon-arrow-down"></span></button></a>';
                                                            echo '&#160;';
                                                        }
                                                        if($PAGE['pages_active'] == 0)
                                                        {
                                                            echo '<a data-toggle="tooltip" data-placement="top" title="Seite aktivieren" class="activator tt" href="' . _BASE_URL . '/constructr/pages/activate/' . $PAGE['pages_id'] . '/"><button type="button" class="btn btn-danger btn-xs" title="deaktiviert und unsichtbar"><span class="glyphicon glyphicon-eye-close"></span></button></a>';
                                                            echo '&#160;';
                                                        }
                                                        else
                                                        {
                                                            echo '<a data-toggle="tooltip" data-placement="top" title="Seite deaktivieren" class="activator tt" href="' . _BASE_URL . '/constructr/pages/deactivate/' . $PAGE['pages_id'] . '/"><button type="button" class="btn btn-success btn-xs" title="aktiviert und sichtbar"><span class="glyphicon glyphicon-eye-open"></span></button></a>';
                                                            echo '&#160;';
                                                        }
                                                        echo '<a data-toggle="tooltip" data-placement="top" title="Neue Unterseite erstellen" class="new_sub tt" href="' . _BASE_URL . '/constructr/pages/new/sub/' . $PAGE['pages_id'] . '/' . $PAGE['pages_lft'] . '/"><button type="button" class="btn btn-warning btn-xs" title="Neue Unterseite erstellen"><span class="glyphicon glyphicon-plus"></span></button></a>';
                                                        echo '&#160;';
                                                        echo '<a data-toggle="tooltip" data-placement="top" title="Inhalte von Seite ' . $PAGE['pages_name'] . ' bearbeiten" class="editercontent tt" href="' . _BASE_URL . '/constructr/content/' . $PAGE['pages_id'] . '/"><button type="button" class="btn btn-info btn-xs" title="Inhalte von Seite ' . $PAGE['pages_name'] . ' bearbeiten"><span class="glyphicon glyphicon-pencil"></span></button></a>';
                                                        echo '&#160;';
                                                        echo '<a data-toggle="tooltip" data-placement="top" title="Seite ' . $PAGE['pages_name'] . ' bearbeiten" class="editer tt" href="' . _BASE_URL . '/constructr/pages/edit/' . $PAGE['pages_id'] . '/"><button type="button" class="btn btn-success btn-xs" title="Seite ' . $PAGE['pages_name'] . ' bearbeiten"><span class="glyphicon glyphicon-pencil"></span></button></a>';
                                                        echo '&#160;';
                                                        echo '<a data-toggle="tooltip" data-placement="top" title="Diese Seite l&ouml;schen" class="deleter-single tt" href="' . _BASE_URL . '/constructr/pages/delete-single/' . $PAGE['pages_id'] . '/' . $PAGE['pages_lft'] . '/' . $PAGE['pages_rgt'] . '/" title="Seite l&ouml;schen"><button type="button" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></button></a>';
                                                        echo '&#160;';
                                                        echo '<a data-toggle="tooltip" data-placement="top" title="Diese Seite rekursiv l&ouml;schen" class="deleter-recursive tt" href="' . _BASE_URL . '/constructr/pages/delete-recursive/' . $PAGE['pages_id'] . '/' . $PAGE['pages_lft'] . '/' . $PAGE['pages_rgt'] . '/" title="Seite rekursiv l&ouml;schen"><button type="button" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove-circle"></span></button></a>';
                                                        echo '</nobr></td>';
                                                        echo '</tr>';
                                                    }
                                                }
