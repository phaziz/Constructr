        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <div class="jumbotron">
                            <h2>Detailansicht | <a href="<?php echo _BASE_URL . '/admin/media/' ?>" class="tt" data-toggle="tooltip" data-placement="top" title="Zur&uuml;ck zur &Uuml;bersicht">zur&uuml;ck</a></h2>
                            <br><br>
                                <?php
                                    if($DETAILS){
