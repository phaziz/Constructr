<!DOCTYPE html>
    ...
    <!--[if gt IE 8]><!--> <html class="no-js" lang="en"><!--<![endif]-->
        <head>
            ...
            <link href="<?php echo $_CONSTRUCTR_CONF['_BASE_URL'];?>/Assets/jasny-bootstrap-3.1.0-dist/css/jasny-bootstrap.min.css" rel="stylesheet">
            <!--[if lt IE 9]>
        ...
        <body>
            ...
            <script src="<?php echo $_CONSTRUCTR_CONF['_BASE_URL'];?>/Assets/jasny-bootstrap-3.1.0-dist/js/jasny-bootstrap.min.js"></script>
            <script>
                $(function ()
                    {
